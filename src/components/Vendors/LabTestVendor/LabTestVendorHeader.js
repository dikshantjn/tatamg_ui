...
const LabTestVendorHeader = ({ 
  ...
  const handleProfileClick = () => {
    handleProfileMenuClose();
    navigate('/vendor/lab-test/profile');
  ...
  const notifications = [
    { id: 1, message: 'New booking #1234 received', time: '2 min ago', read: false },
    { id: 2, message: 'Test results ready for patient #5678', time: '15 min ago', read: false },
    { id: 3, message: 'Payment received for booking #1230', time: '1 hour ago', read: true },
  ];
      ...
      <Toolbar sx={{ 
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <Science sx={{ color: 'primary.main', fontSize: '1.5rem' }} />
            <Typography 
              variant="h6" 
              component="div" 
              sx={{ 
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Tooltip title="Profile">
            ...
            >
              ...
              >
                {vendorData?.email?.charAt(0)?.toUpperCase() || 'L'}
              </Avatar>
            </IconButton>
          </Tooltip>
        </Box>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
            ...
            <Box>
              <Typography variant="subtitle2" sx={{ fontWeight: 600 }}>
                {vendorData?.email?.split('@')[0] || 'Lab Vendor'}
              </Typography>
...
export default LabTestVendorHeader;
