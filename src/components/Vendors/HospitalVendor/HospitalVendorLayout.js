...
const HospitalVendorLayout = ({ children, title = "Hospital Vendor Service" }) => {
  ...
  const menuItems = [
    ...
    { text: 'Wards', icon: <Bed />, path: '/vendor/hospital/wards' },
    { text: 'Appointments', icon: <Schedule />, path: '/vendor/hospital/appointments' },
    { text: 'History', icon: <History />, path: '/vendor/hospital/history' },
    { text: 'Profile', icon: <People />, path: '/vendor/hospital/profile' },
  ...
  if (loading) {
    return (
      <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
        <Typography>Loading hospital vendor dashboard...</Typography>
      </Box>
    );
  }
  ...
  return (
    <Box sx={{ display: 'flex', height: '100vh' }}>
      ...
      >
        <MenuItem onClick={() => { handleMenuClose(); handleNavigation('/vendor/hospital/profile'); }}>
          <ListItemIcon>
            <AccountCircle fontSize="small" />
          </ListItemIcon>
          My Profile
        </MenuItem>
        <MenuItem onClick={() => { handleMenuClose(); handleNavigation('/vendor/hospital/settings'); }}>
          <ListItemIcon>
...
export default HospitalVendorLayout; 