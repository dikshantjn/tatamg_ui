...
function BottomNavigation() {
    ...
    const handleEmergencyClick = () => {
        // Add your emergency modal logic here
    };

    return (
        <div className={`bottom-nav-container ${isVisible ? '' : 'hidden'}`}>
            <div className="nav-curved-bg" />
            <nav className="bottom-nav">
                ...
                <div className="speak-button-wrapper">
                    ...
                    >
                        <div className="speak-button-inner">
                ...
                {/* Emergency Button */}
                <button onClick={handleEmergencyClick} className="nav-item emergency-button">
